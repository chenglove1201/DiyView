...
import com.cheng.diyview.CircleImageView;
 ...
 * </p>
 */
public class Tyr extends ViewGroup implements NestedScrollingParent,
     ...
     * @param attrs
     */
    public Tyr(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(Tyr parent, @Nullable View child);
    }
}
