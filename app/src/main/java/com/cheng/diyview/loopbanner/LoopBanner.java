package com.cheng.diyview.loopbanner;
...
public class LoopBanner extends ViewGroup {
    ...
    public LoopBanner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        dotDiameter = typedArray.getDimensionPixelSize(R.styleable.LoopBanner_indication_diameter, dotDiameter);
        dotMargin = typedArray.getDimensionPixelSize(R.styleable.LoopBanner_indication_margin, dotMargin);
        scrollDuration = typedArray.getInteger(R.styleable.LoopBanner_scroll_duration, scrollDuration);
        indicationNormal = typedArray.getInteger(R.styleable.LoopBanner_indication_normal, indicationNormal);
        indicationSelected = typedArray.getInteger(R.styleable.LoopBanner_indication_selected, indicationSelected);
        typedArray.recycle();
     ...
     * 设置指示器位置
     */
    private void setIndicationPosition() {
        invalidate();
    }
