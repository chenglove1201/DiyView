...
package com.icandemy.diyview.tablayout;
...
import com.icandemy.diyview.animator.ValueAnimatorCompat;
import com.icandemy.diyview.animator.ValueAnimatorCompatImplGingerbread;
import com.icandemy.diyview.animator.ValueAnimatorCompatImplHoneycombMr1;
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ValueAnimatorCompat animator = mIndicatorAnimator = createAnimator();
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                ...
                rectF.left = mIndicatorLeft;
                rectF.top = (getHeight() - mSelectedIndicatorHeight) / 2;
                rectF.right = mIndicatorRight;
                rectF.bottom = getHeight() - (getHeight() - mSelectedIndicatorHeight) / 2;
                mSelectedIndicatorPaint.setAntiAlias(true);
                canvas.drawRoundRect(rectF, 50, 50, mSelectedIndicatorPaint);
            }
        }
    }
